...
DOWNLOADS = [
    ...
    },
    {
        ...
        "items": [
            ...
            (
                "封面展開 Word（示意）",
                "zhuangzi-atlas-cover-wrap.docx",
                "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
                False,
            ),
            ("書脊 PDF（32×210 mm）", "zhuangzi-atlas-spine.pdf", "application/pdf", False),
            (
                "書脊 Word",
            ...
            ("封面單頁 PDF", "zhuangzi-atlas-cover.pdf", "application/pdf", False),
            (
                "封面 Word（示意）",
                "zhuangzi-atlas-cover.docx",
                "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
                False,
            ),
            ("封底單頁 PDF", "zhuangzi-atlas-back.pdf", "application/pdf", False),
            (
                "封底 Word（示意）",
                "zhuangzi-atlas-back.docx",
                "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
                False,
            ),
            ("作者折頁 PDF", "zhuangzi-atlas-flap.pdf", "application/pdf", False),
            (
                "作者折頁 Word（示意）",
                "zhuangzi-atlas-flap.docx",
                "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
                False,
            ),
        ],
