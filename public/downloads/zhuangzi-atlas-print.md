...
**走讀路線**：身體隱喻（駢拇贅疣）→ 正正守分 → 伯夷盜跖並置。建議與〈馬蹄〉〈胠篋〉〈在宥〉連讀，同一條「外加仁義、治術傷性」的線。
...
**走讀路線**：馬之真性 → 伯樂治馬 → 陶匠規矩 → 赫胥氏對照。讀時抓住一句話：**誰在說「我善治」？誰在付代價？**
